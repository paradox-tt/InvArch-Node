...
benchmarks! {
  ...
  create_ips {
      ...
      Pallet::<T>::inner_create_ips(RawOrigin::Signed(bob.clone()).into(), metadata_1.clone(), assets.clone(), true, license.clone(), percent!(50), One, false)?;

  }: _(RawOrigin::Signed(bob), metadata_1, assets, true, license, percent!(50), One, false)
